...
class Company:
    ...
    def add_new_employee(self, name, last_name, middle_name, new_id, email, url, phone, is_active):
        employee = {
            "id": 0,
            "firstName": name,
            "lastName": last_name,
    ...
    def update_employee_info(self, id, last_name, email, url, phone, is_active):
        user_info = {
            "lastName": last_name,
            "email": email,
            "url": url,
